...
const BookYourRide = () => {
  ...
  return (
    <div className="mt-32 mb-32 px-4 " ref={ref}>
      <motion.h1 className="text-4xl md:text-5xl font-bold text-center text-text mb-16" initial={{ opacity: 0, y: -40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
          ...
          return (
            <motion.div key={i} custom={i} variants={fadeUp} initial="hidden" animate={controls}>
              <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10}>
                  <div className="relative bg-text/85 backdrop-blur-xl border border-bgwhite/20 rounded-2xl p-5 hover:shadow-xl transition-shadow duration-300">
