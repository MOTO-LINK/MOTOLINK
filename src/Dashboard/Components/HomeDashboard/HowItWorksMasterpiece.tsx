      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
          <motion.div  className="mb-20 text-center" style={{ y: y2 }}>
                <motion.h1 className="text-5xl font-extrabold tracking-tight sm:text-7xl" initial={{ opacity: 0, y: -50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
                  <span className="block bg-gradient-to-r from-textWhite  to-textWhite/50 bg-clip-text text-transparent">
                    How It Works with motoLink
                  </span>
                </motion.h1>
                
                <motion.p className="mx-auto mt-6 max-w-2xl text-lg text-textWhite/80" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.2 }} viewport={{ once: true }}>
