...
const RideOptions = () => {
  return (
    <section className="mt-20 mb-32 px-6">
      ...
      <motion.h1 className="text-4xl md:text-5xl font-bold text-center text-text mb-16" initial={{ opacity: 0, y: -40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
