...
class CustomTextfield extends StatelessWidget {
  const CustomTextfield({super.key, required this.Textfieldmodels, required this.color});
...
final coolors color;
  ...
  decoration: InputDecoration(
    prefixIcon: Textfieldmodels.prefixIcon,prefixIconColor: coolors().secondaryColor,
    suffixIcon: Textfieldmodels.suffixIcon,suffixIconColor: coolors().secondaryColor,
   iconColor:color.secondaryColor ,  
    contentPadding: EdgeInsets.symmetric(horizontal: 20, vertical: 15),
    filled: true,
    fillColor: coolors().TextField.withOpacity(0.1),
