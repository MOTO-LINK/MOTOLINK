...
final ColorsApp color;
  ...
  decoration: InputDecoration(
    prefixIcon: Textfieldmodels.prefixIcon,prefixIconColor: ColorsApp().secondaryColor,
    suffixIcon: Textfieldmodels.suffixIcon,suffixIconColor: ColorsApp().secondaryColor,
