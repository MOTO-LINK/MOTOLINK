        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              CustomTextField(hint: "Enter your Full Name", label: "Full Name",keyboardType:TextInputType.name),
              const SizedBox(
                height: 35,
              ),
              CustomTextField(hint: "015*******68", label: "Phone Number", keyboardType: TextInputType.number,
                phoneIcon: true,),
              const SizedBox(
                height: 35,
              ),
              CustomTextField(hint: "Enter your Password", label: "Password", keyboardType: TextInputType.visiblePassword,
                passwordIcon: true,),
              ...
              CustomTextField(hint: "Enter your National ID", label: "National ID",keyboardType:TextInputType.number),
